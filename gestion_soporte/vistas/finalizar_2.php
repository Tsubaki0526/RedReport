  ...
  echo "
    ...
    <script>
        Swal.fire({
            ...
            window.location = 'lista_gestion_2.php';
        });
    </script>";
  exit;
}
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="../controles/finalizar_reportes_controles_2.php">
                <?= csrf_field() ?>
                ...
                <div class="text-end">
                  ...
                  <a href="lista_gestion_2.php" class="btn btn-secondary">Cancelar</a>
                </div>
              </form>
            </div> 
          </div> 
