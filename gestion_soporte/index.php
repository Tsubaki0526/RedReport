  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        backgroundColor: ['rgba(37, 99, 235, 0.7)','rgba(22, 163, 74, 0.7)','rgba(245, 158, 11, 0.7)','rgba(239, 68, 68, 0.7)','rgba(139, 92, 246, 0.7)'],
        borderWidth: 0,
        borderRadius: 6,
        barPercentage: 0.6
      }]
    ...
    options: {
      ...
      scales: { y: { beginAtZero: true, ticks: { precision: 0, font: { size: 12 } }, grid: { color: '#f1f5f9' } }, x: { grid: { display: false }, ticks: { font: { size: 11 } } } }
    }
  });
});
</script>
