...
include('../../sesion.php');
include('../../parte1.php');
include('../controles_liberty/consultas.php');
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Lista de Reportes De Liberty</h1>
                </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card shadow-sm border-left-primary">
            <div class="card-body py-2 px-5">
                <small class="text-muted">Último Radicado Generado Del Cliente Liberty</small><br>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Reportes Registrados De Liberty</h3>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <?php
                                include('../controles_liberty/lista_reportes_liberty.php');
                                foreach ($reportes as $reporte) {
                                    $id_liberty_registrado = $reporte['id_liberty_registrado'];
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="acciones" style="text-align:center;">
                                            <a href="finalizar_liberty_2.php?id_liberty_registrado=<?= $id_liberty_registrado ?>" class="btn btn-warning btn-sm">
