...
$id_azteka_registrado = isset($_GET['id_azteka_registrado']) ? (int) $_GET['id_azteka_registrado'] : 0;

// Buscar datos del Reporte
$sqlReporte = "SELECT * FROM tb_azteka WHERE id_azteka_registrado = :id_azteka_registrado LIMIT 1";
$queryReporte = $pdo->prepare($sqlReporte);
$queryReporte->execute([':id_azteka_registrado' => $id_azteka_registrado]);
...
if (!$reporte) {
    ...
    <script>
        Swal.fire({
            ...
            text: 'El reporte con ID " . $id_azteka_registrado . " no existe o fue eliminado.',
            confirmButtonText: 'Volver'
        }).then(() => {
            window.location = 'lista_azteka_2.php';
        });
    </script>";
    exit;
}
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="../controles_azteka/finalizar_reporte_azteka_2.php" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                <input type="hidden" name="id_azteka_registrado" value="<?= $reporte['id_azteka_registrado'] ?>">
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="lista_azteka_2.php" class="btn btn-secondary">Cancelar</a>
                                </div>
                            </form>
                        </div> 
                    </div> 
