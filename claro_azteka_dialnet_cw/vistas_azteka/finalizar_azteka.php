...
if (!$reporte) {
    ...
    <script>
        Swal.fire({
            ...
            window.location = 'lista_azteka.php';
        });
    </script>";
    exit;
}
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="../controles_azteka/finalizar_reporte_azteka.php" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="lista_azteka.php" class="btn btn-secondary">Cancelar</a>
                                </div>
                            </form>
                        </div> 
                    </div> 
