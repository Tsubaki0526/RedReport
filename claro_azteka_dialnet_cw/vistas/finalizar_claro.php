...
if (!$reporte) {
    ...
    <script>
        Swal.fire({
            ...
            window.location = 'lista_claro.php';
        });
    </script>";
    exit;
}
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="../controles/finalizar_reporte_claro.php" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="lista_claro.php" class="btn btn-secondary">Cancelar</a>
                                </div>
                            </form>
                        </div> 
                    </div> 
