...
include('../../sesion.php');
include('../../parte1.php');
include('../controles_dialnet/consultas.php');
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Lista de Reportes De Dialnet</h1>
                </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card shadow-sm border-left-primary">
            <div class="card-body py-2 px-5">
                <small class="text-muted">Último Radicado Generado Del Cliente Dialnet</small><br>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Reportes Registrados De Dialnet</h3>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <?php
                                include('../controles_dialnet/lista_reportes_dialnet.php');
                                foreach ($reportes as $reporte) {
                                    $id_dialnet_registrado = $reporte['id_dialnet_registrado'];
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="acciones" style="text-align:center;">
                                            <a href="finalizar_dialnet_2.php?id_dialnet_registrado=<?= $id_dialnet_registrado ?>" class="btn btn-warning btn-sm">
