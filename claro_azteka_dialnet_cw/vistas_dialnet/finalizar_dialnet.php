...
if (!$reporte) {
    ...
    <script>
        Swal.fire({
            ...
            window.location = 'lista_dialnet.php';
        });
    </script>";
    exit;
}
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="../controles_dialnet/finalizar_reporte_dialnet.php" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="lista_dialnet.php" class="btn btn-secondary">Cancelar</a>
                                </div>
                            </form>
                        </div> 
                    </div> 
