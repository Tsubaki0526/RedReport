...
$sql_reportes = "SELECT r.id_claro_registrado, r.radicado, r.cliente, r.ciudad, r.telefono, r.fecha, r.hora, r.dano_reportado, r.estado,
                 ...
                 FROM tb_claro r
                 LEFT JOIN tb_claro_finalizacion f 
                 ON r.id_claro_registrado = f.id_claro_registrado";
