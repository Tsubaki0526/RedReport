...
$sql_reportes = "SELECT r.id_azteka_registrado, r.radicado, r.cliente, r.ciudad, r.telefono, r.fecha, r.hora, r.dano_reportado, r.estado,
                 ...
                 ON r.id_azteka_registrado = f.id_azteka_registrado";
