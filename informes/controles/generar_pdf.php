...
<tr><td><?= $r['id_venta'] ?></td><td><?= hescape($r['cn']??'-') ?></td><td><?= hescape($r['vn']??'-') ?></td><td><?= hescape($r['pn']??'-') ?></td><td class="text-right">$<?= number_format($r['monto'],0) ?></td><td><?= $r['tipo_venta'] ?></td><td><?= $r['fecha'] ?></td></tr>
<?php endwhile; ?>
