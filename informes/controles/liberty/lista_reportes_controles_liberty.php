...
$sql_reportes = "SELECT r.id_liberty_registrado, r.radicado, r.cliente, r.ciudad, r.telefono, r.fecha, r.hora, r.dano_reportado, r.estado,
                 ...
                 FROM tb_liberty r
                 LEFT JOIN tb_liberty_finalizacion f 
                 ON r.id_liberty_registrado = f.id_liberty_registrado";
