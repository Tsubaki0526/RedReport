                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" class="mb-3">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-auto">
                                    ...
                                    <a href="../vistas/informe_azteca_2.php" class="btn btn-sm btn-secondary">
                        ...
                        <table id="example1" class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <?php
                                include('../controles/lista_reportes_controles_azteca.php');
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="informe_azteca_pdf.php?id=<?= $reporte['id_azteka_registrado'] ?>"
