                        ...
                        <form method="GET" class="mb-3">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-auto">
                                    ...
                                    <a href="../vistas/informe_reportes.php" class="btn btn-sm btn-secondary">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($reporte['fecha_finalizado'] ?? '-') ?></td>
                                        <td><?= htmlspecialchars($reporte['hora_finalizado'] ?? '-') ?></td>
                                        <td><?= htmlspecialchars($reporte['personal_encargado'] ?? '-') ?></td>
                                        <td style="max-width:200px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
